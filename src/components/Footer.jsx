...
const Footer = () => {
    return (
        <div className="flex justify-center py-10 bg-[#1B1B1B] max-md:px-5">
            <div className='max-w-[1280px]'>
                    ...
                    <div className="flex gap-20 max-md:flex-col max-md:gap-0">
                        ...
                        <div className="flex flex-col  w-[30%] max-md:ml-0 max-md:w-full">
                            <div className="flex flex-col pt-1.5 text-base leading-6 text-opacity-60 max-md:mt-10" >
                                <div className="text-[24px] font-[700] leading-[28px] max-md:mr-0.5">
                                    <h3>Contact</h3>
                                </div>
                                <div className="flex gap-3 mt-5 leading-6 max-md:mr-1.5">
                                    ...
                                    />
                                    <div>
                                        <p>219 Gardenbrooke Trail, Brampton, Ontario, L6P3C9</p> </div>
                                </div>
                        ...
                        <div className="flex flex-col w-[12%] ml-5 max-md:ml-0 max-md:w-full" >
                            <div className="flex flex-col py-0.5 text-base leading-6 whitespace-nowrap max-md:mt-10">
                                ...
                                <Link className="mt-4">
                                    <p className=' hover:text-[#8E7861] transition-colors duration-300'>Home</p>
                                </Link>
                                <Link className="mt-3  ">
                                    <p className='hover:text-[#8E7861] transition-colors duration-300'>About</p>
                                </Link>
                                <Link className="mt-3 ">
                                    <p className=' hover:text-[#8E7861] transition-colors duration-300'>Work</p>
                                </Link>
                                <Link className="mt-3 ">
                                    <p className=' hover:text-[#8E7861] transition-colors duration-300'>Blog</p>
                                </Link>
                                <Link className="mt-3 ">
                                    <p className=' hover:text-[#8E7861] transition-colors duration-300'>Contact</p>
                                </Link>
                            </div>
                        </div>
                        <div className="flex flex-col w-[40%] justify-start max-md:ml-0 max-md:w-full">
                            <div className="flex flex-col grow max-md:mt-10">
                                ...
                                <div className="mt-8 text-[24px] font-[700] leading-[28px] max-md:mr-0">
                                    <h3>
                                        Follow US
                                    </h3></div>
                ...
                <div className="mt-10 border-1 border-red-700" style={{ borderBottom: ".5px solid #473C30" }} />
                <div className="flex gap-5 justify-between mt-10 text-xs leading-5 max-md:flex-wrap max-md:mt-10 max-md:mr-2.5 max-md:max-w-full">
                    <div className="flex gap-2">
                        ...
                        <div className="flex-auto">
                            <p>Design & Developed by <Link to="https://eazotel.com/">Eazotel</Link></p>
                        </div>
