        ...
        <section className="layout-section">
            <div className="max-width">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-10 md:mt-20 mt-10">
                    {data.map((item) => (
                        <div className="flex flex-col border group hover:shadow-inner py-10 px-4 shadow-[#473C30] hover:scale-95 justify-center border-[#473C30] p-8 gap-6 items-center">
